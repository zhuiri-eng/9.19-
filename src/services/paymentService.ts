...
const PAYMENT_CONFIG = {
  ...
  callbackUrl: 'https://spontaneous-haupia-55e958.netlify.app/payment/callback', // 同步回调地址（用户支付完成后跳转）
  notifyUrl: 'https://spontaneous-haupia-55e958.netlify.app/.netlify/functions/payment-callback', // 异步回调地址（Netlify Function）
